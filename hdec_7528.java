...
class hdec_7528 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Compressor_7528 deSer = new Compressor_7528();
        ...
        try {
            ...
            deSer = (Compressor_7528)in.readObject();

            in.close();
            file2.close();

            System.out.println("Object has been deserialized ");
            System.out.println("deser.root.b = " + deSer.root.b);
        ...
        String resultBits = toString(deSer.bits);

        System.out.println(resultBits);
